...
class AddTodo extends Component {
    ...
    render() {
      return (
        ...
        <div>
          <TextField label = "Add New Item" data-testid="new-item-input" variant = "outlined" onChange={this.handleChange} value={this.state.value} />
          <Button style={{marginLeft: "5px"}} onClick={this.handleSubmit} color="primary" variant="contained" size="small" data-testid="new-item-button">Insert</Button>
        </div>
      );
    }
  }
